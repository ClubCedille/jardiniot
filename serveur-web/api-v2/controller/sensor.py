...
class SensorController(object):
    ...
    def createCommandLight(white, blue, red):
        ...
        return "id 1 c 2 200 i " + str(9 * 256 + int(white)) + " " + str(10 * 256 +
                                                                         int(blue)) + " " + str(11 * 256 + int(red))
    ...
    def update_fans(request):
        ...
        if fanl is not None:
            ...
            db = Database.get_instance()
            db.executeparam(
                "INSERT INTO valeurs(date, senseur, valeur) VALUES (?, ?, ?);", [
                    datenow, 'FanL', str(fanl)])
            # Command
