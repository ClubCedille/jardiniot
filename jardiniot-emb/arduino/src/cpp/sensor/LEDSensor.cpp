...
LEDSensor::LEDSensor(byte idController, std::vector<short> inputPins, std::vector<short> outputPins, short delay)
    : SensorStrategy(idController, ControllerType::LED, inputPins, outputPins)
{
    ledPin = outputPins[0];
