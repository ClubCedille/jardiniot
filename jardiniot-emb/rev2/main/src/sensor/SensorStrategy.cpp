...
//<<constructor>>
SensorStrategy::SensorStrategy( unsigned char idController, ControllerType type,
...
std::string SensorStrategy::read( ) { return ""; }

int SensorStrategy::write( ) { return 0; }
...
std::string SensorStrategy::toString( ) { return ""; }