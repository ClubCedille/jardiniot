...
public:
    ...
    // constructor
    MotorStrategy();
    MotorStrategy(unsigned char idController, ControllerType type, std::vector<short> inputPin, std::vector<short> outputPin);
    MotorStrategy(unsigned char idController, ControllerType type, short output, short input);
